...
- README 파일 작성시, 아래 작성양식에 기재된 5가지 항목 내용은 필수로 작성해야 합니다.
- 아래 항목 및 내용은 이해를 돕기위한 예시이며, 참고하여 자유롭게 추가 및 작성해도 됩니다.
- 팀 깃허브 주소 -> `https://github.com/계정명/저장소명`
- 저장소명 작성규칙 : 프로젝트 번호를 저장소 이름으로 작성합니다.(예 : 25_HC001, 팀오피스 메인에서 확인 가능합니다.)
- 예시) 프로젝트 번호가 25_HC001일 경우 -> `https://github.com/hanium/25_HC001`
